function v1_clear_gt_callback(src, ~)
    ...
    if current_scan_key_exists
        ...
        value_already_populated = ~cellfun(@isempty,ground_truth_table(deletion_row,:).v1_GT_rectangle);
    ...
    if permission_to_clear
        ...
        if current_scan_key_exists
            ...
            scan_key_rows = find(ground_truth_table.scan_key == current_scan_key);
            deletion_row = scan_key_rows(GT_index);
            ground_truth_table.v1_GT_rectangle(deletion_row,:) = {[]};          
